    ...
    public class AnswersRepository : IAnswersRepository
    {
        ...
        public void DeleteAnswer(int aid)
        {
            ...
            if (ans != null)
            {
                ...
                db.SaveChanges();
                qr.UpdateQuestionAnswersCount(ans.QusetionID, -1);
            }
        }
        ...
        {
            List<Answer> ans = db.Answers.Where(temp => temp.QusetionID == qid).OrderByDescending(temp => temp.AnswerDateAndTime).ToList();
            return ans;
        }
        ...
        public void InsertAnswer(Answer a)
        {
            db.Answers.Add(a);
            db.SaveChanges();
            qr.UpdateQuestionAnswersCount(a.QusetionID, 1);
        }
        ...
        public void UpdateAnswerVotesCount(int aid, int uid, int value)
        {
            ...
            if (ans != null)
            {
                ...
                db.SaveChanges();
                qr.UpdateQustionVotesCount(ans.QusetionID, value);
